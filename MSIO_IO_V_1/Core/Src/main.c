...
static void MX_GPIO_Init(void) {
	...
	HAL_GPIO_WritePin(LED_PC_13_GPIO_Port, LED_PC_13_Pin, GPIO_PIN_RESET);

	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOA, U1_74HC_S3_Pin | U1_74HC_S2_Pin, GPIO_PIN_RESET);
	...
	HAL_GPIO_Init(LED_PC_13_GPIO_Port, &GPIO_InitStruct);

	/*Configure GPIO pins : U1_74HC_S3_Pin U1_74HC_S2_Pin */
	GPIO_InitStruct.Pin = U1_74HC_S3_Pin | U1_74HC_S2_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
